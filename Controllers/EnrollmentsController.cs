...
namespace LW_WEB.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public EnrollmentsController(LwWebContext context)
        {
            _context = context;
        }
        ...
        {
            var lwWebContext = _context.Enrollments.Include(e => e.Course).Include(e => e.Student);
            return View(await lwWebContext.ToListAsync());
        }
